...
model_setting_1 = f'Decom_True_d_measures_Smote_True_0.2_control_True'
model_setting_2 = f'Decom_True_d_measures_Smote_True_0.5_control_True'
model_setting_3 = f'Decom_True_d_measures_Smote_True_0.8_control_True'

model_settings = [model_setting_1, model_setting_2, model_setting_3]
...
def test():
    ...
    for each_model_setting in model_settings:
        ...
        for rnd_state in [0,1,2,3,4,5,6,7,10,12,13,15,16,17,18,19]:
            for runtime in range(5):
                ...
                temp_list.append(float(res_dict[f'val_averaged_top3_svr']))
            total_res_dict[each_model_setting][f'state_{rnd_state}'] = np.median(np.array(temp_list))
